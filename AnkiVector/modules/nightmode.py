# Copyright (C) 2021 Dilasnaafk

# This file is part of Alexie (Telegram Bot)
...
from AnkiVector.function.telethonbasics import is_admin
from AnkiVector.services.sql.night_mode_sql import (
    add_nightmode,
    get_all_chat_id,
    is_nightmode_indb,
    rmnightmode,
